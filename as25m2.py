...
val1 = client.get_node("ns=2;i=778")
val2 = client.get_node("ns=2;i=779")
val3 = client.get_node("ns=2;i=780")
val4 = client.get_node("ns=2;i=781")
val5 = client.get_node("ns=2;i=782")
val6 = client.get_node("ns=2;i=783")
