...
val1 = client.get_node("ns=2;i=556")
val2 = client.get_node("ns=2;i=557")
val3 = client.get_node("ns=2;i=558")
val4 = client.get_node("ns=2;i=559")
val5 = client.get_node("ns=2;i=560")
val6 = client.get_node("ns=2;i=561")
