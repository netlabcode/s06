...
val1 = client.get_node("ns=2;i=772")
val2 = client.get_node("ns=2;i=773")
val3 = client.get_node("ns=2;i=774")
val4 = client.get_node("ns=2;i=775")
val5 = client.get_node("ns=2;i=776")
val6 = client.get_node("ns=2;i=777")
