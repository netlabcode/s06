...
val1 = client.get_node("ns=2;i=568")
val2 = client.get_node("ns=2;i=569")
val3 = client.get_node("ns=2;i=570")
val4 = client.get_node("ns=2;i=571")
val5 = client.get_node("ns=2;i=572")
val6 = client.get_node("ns=2;i=573")
val7 = client.get_node("ns=2;i=835")
